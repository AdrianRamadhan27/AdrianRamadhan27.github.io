...
const UnderMaintanance = () => {
	return (
        <section class="bg-white dark:bg-gray-900">
            <div class="py-8 px-4 mx-auto max-w-screen-md text-center lg:py-64 lg:px-12">
                ...
                <p class="font-light text-gray-500 md:text-lg xl:text-xl dark:text-gray-400">Still working on it...</p>
            </div>
        </section>
	);
};
